    ...
    <div className="fixed inset-0 z-50 overflow-y-auto" role="dialog" aria-modal="true" aria-labelledby="success-title">
      ...
      <div className="flex min-h-screen items-center justify-center p-6">
        <div className="relative w-full max-w-md bg-white rounded-lg py-[34px] px-[24px] shadow-2xl z-10 text-center transition-all transform duration-300 animate-fade-in">
          ...
          {/* Heading (완료 헤더) */}
          <h2 id="success-title" className="text-preset-5-bold text-black">
            Thanks for your support!
          </h2>

          {/* Info Text (안내 본문) */}
          <p className="mt-4 text-preset-8-regular md:text-preset-7-regular text-gray-500">
          ...
          <div className="mt-8">
            <button
              onClick={onClose}
              className="px-8 py-3.5 bg-green-400 hover:bg-green-700 text-white text-preset-7-medium font-bold rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-400/50"
            >
              Got it!
            </button>
          </div>
